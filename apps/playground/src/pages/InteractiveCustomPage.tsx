...
export function InteractiveCustomPage(): ReactElement {
  ...
  return (
    <div className="page--interactive page--interactive-custom mx-auto w-full max-w-[1480px] px-[clamp(20px,4vw,64px)] pt-[clamp(34px,5vw,70px)] pb-20 max-[560px]:px-3.5">
