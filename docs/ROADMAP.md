...
- 2026-08-01: Completed React composition/DX Slice 6. Focused DOM adapters now own
  ...
  translation, focus bridging, measurement/ResizeObserver cleanup, and the native
  non-passive wheel listener. `Gantt.tsx` is 1,680 lines, focused browser-adapter
  coverage passed 5 files / 68 tests, the complete React DOM selection passed 8 files
  / 92 tests, and `mise run ci` passed 93 files / 493 tests with 196 build artifacts.
